...
class MainActivity : AppCompatActivity() {
    ...
    private fun applyTheme(theme: ThemeManager.UiTheme) {
        ...
        val scrollButtonBg = if (theme.menuTint != 0) theme.menuTint else 0xFF111827.toInt()
        scrollToBottomButton.backgroundTintList = android.content.res.ColorStateList.valueOf(scrollButtonBg)
        scrollToBottomButton.setColorFilter(theme.sendTint)
