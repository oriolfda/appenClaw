...
**AIGOR App é unha app Android para comunicarte co teu asistente OpenClaw** con texto, audio, imaxes e vídeo.
...
- **2.1** Crea un repositorio novo no teu GitHub (ex. `aigor-app`)
...
2. Título, por exemplo `aigor-app-assistant`
